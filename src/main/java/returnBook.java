...
public class returnBook extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if(rs.next()){
                ResultSet rs1=st.executeQuery("select * from issue where bookID='"+bookID+"' and studentID='"+studentID+"' and returnBook='NO'");
                if(rs1.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "The books is already returned");
                    setVisible(false);
